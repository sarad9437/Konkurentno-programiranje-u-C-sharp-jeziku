...
Projektni rad iz predmeta Konkurentno i distribuirano programiranje.
...
| 02 | MutexKarte | Check-Then-Act problem (prodaja karte) |
...
Za pokretanje pojedinačnog projekta: 
desni klik na projekat u Solution Explorer-u 
Set as Startup Project
Ctrl+F5.

Alternativno, iz terminala npr:
